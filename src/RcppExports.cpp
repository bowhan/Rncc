...
RcppExport SEXP _Rncc_ConnectedComponents(SEXP strsSEXP, SEXP mmallowedSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< std::vector<std::string> >::type strs(strsSEXP);
    Rcpp::traits::input_parameter< int >::type mmallowed(mmallowedSEXP);
    rcpp_result_gen = Rcpp::wrap(ConnectedComponents(strs, mmallowed));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_Rncc_ConnectedComponents", (DL_FUNC) &_Rncc_ConnectedComponents, 2},
    {NULL, NULL, 0}
};
